      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center">
            <img src="/pnglunalogo.png" alt="Logo" className="w-32 h-32" />
            <span
              className="ml-2 text-3xl font-bold text-[#ffb3ab]"
              style={{ fontFamily: "Kaushan Script, cursive" }}
            >
              Tian Sanación Holística
            </span>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden flex flex-col items-center space-y-4 mt-4 bg-white p-4 shadow-md rounded-lg">
            {[
              { href: "/", label: "Home" },
